...
#  Dec 26, 2019 12:35:50 PM PKT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 2179x1446+650+150
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $top.lab43 \
        ...
        -foreground $vTcl(actual_gui_fg) -text {Password Recovery} 
    ...
    ###################
    place $top.lab43 \
        -in $top -x 660 -y 240 -width 782 -relwidth 0 -height 338 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $top.ent44 \
        -in $top -x 860 -y 770 -width 574 -relwidth 0 -height 54 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab46 \
        -in $top -x 600 -y 770 -width 242 -relwidth 0 -height 58 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but47 \
        -in $top -x 1150 -y 930 -width 282 -relwidth 0 -height 84 \
        -relheight 0 -anchor nw -bordermode ignore 
